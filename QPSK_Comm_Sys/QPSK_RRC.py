...
class QPSK_RRC(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "QPSK_RRC", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("QPSK_RRC")
        ...
        self.settings = Qt.QSettings("GNU Radio", "QPSK_RRC")
        ...
        self.root_raised_cosine_filter_0_2 = filter.fir_filter_ccf(
            1,
        ...
        self.connect((self.interp_fir_filter_xxx_0, 0), (self.root_raised_cosine_filter_0_0, 0))
        self.connect((self.interp_fir_filter_xxx_0, 0), (self.root_raised_cosine_filter_0_1, 0))
        self.connect((self.interp_fir_filter_xxx_0, 0), (self.root_raised_cosine_filter_0_2, 0))
        self.connect((self.root_raised_cosine_filter_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.root_raised_cosine_filter_0_0, 0), (self.qtgui_freq_sink_x_3, 0))
        self.connect((self.root_raised_cosine_filter_0_1, 0), (self.qtgui_freq_sink_x_1, 0))
        self.connect((self.root_raised_cosine_filter_0_2, 0), (self.qtgui_freq_sink_x_2, 0))
    ...
    def set_sps(self, sps):
        self.sps = sps
        self.root_raised_cosine_filter_0.set_taps(firdes.root_raised_cosine(1, self.samp_rate, (self.samp_rate/self.sps), 0.001, 128))
        self.root_raised_cosine_filter_0_0.set_taps(firdes.root_raised_cosine(1, self.samp_rate, (self.samp_rate/self.sps), 1, 128))
        self.root_raised_cosine_filter_0_1.set_taps(firdes.root_raised_cosine(1, self.samp_rate, (self.samp_rate/self.sps), 0.25, 128))
        self.root_raised_cosine_filter_0_2.set_taps(firdes.root_raised_cosine(1, self.samp_rate, (self.samp_rate/self.sps), 0.5, 128))
...
def main(top_block_cls=QPSK_RRC, options=None):
